...
import CreateAssociateModal from "@/components/modal/CreateAssociateModal";
...
const AdminAssociates = () => {
  ...
  const [selectedAssociate, setSelectedAssociate] = useState<AssociateRead | null>(null);
