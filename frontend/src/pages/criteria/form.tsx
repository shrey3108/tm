                        ...
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                            ...
                            <div className="space-y-4 pt-4 border-t">
                                <div className="space-y-2">
                                    <FormLabel className="text-lg font-bold flex items-center justify-between">Associated Criteria {selectedCriteriaData.length > 0 ? <span className="text-primary text-sm font-bold">
