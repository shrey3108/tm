...
export function MoreJobSetting({ versions }: MoreJobSettingProps) {
    ...
    const selectedFile = watch("project_document") as File | undefined;
    ...
    const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (file) {
            setValue("project_document", file, { shouldValidate: true });
        }
    };
    ...
    const handleClearFile = (e: React.MouseEvent) => {
        e.stopPropagation();
        setValue("project_document", undefined, { shouldValidate: true });
