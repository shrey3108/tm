...
interface RandomPoolSelectorProps {
  poolQuestions: string[];
  poolMcqs: MCQItem[];
  poolTasks: string[];
...
export function RandomPoolSelector({
  poolQuestions,
  poolMcqs,
  poolTasks,
        ...
        <AccordionItem value="questions" className="border-b border-border/20">
          <AccordionTrigger className="hover:no-underline py-3 px-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-semibold text-foreground">Interview Questions Pool</span>
              <Badge variant="secondary" className="rounded-full px-2 py-0.5 text-xs font-semibold">
                {selectedQuestionIndices.length} / {poolQuestions.length} Selected
              </Badge>
            </div>
          </AccordionTrigger>
        ...
        <AccordionItem value="mcqs" className="border-b border-border/20">
          <AccordionTrigger className="hover:no-underline py-3 px-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-semibold text-foreground">MCQ Pool</span>
              <Badge variant="secondary" className="rounded-full px-2 py-0.5 text-xs font-semibold">
                {selectedMcqIndices.length} / {poolMcqs.length} Selected
              </Badge>
            </div>
          </AccordionTrigger>
          <AccordionContent className="pt-0 pb-3 px-4 space-y-3">
        ...
        <AccordionItem value="tasks" className="border-none">
          <AccordionTrigger className="hover:no-underline py-3 px-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-semibold text-foreground">Project Tasks Pool</span>
              <Badge variant="secondary" className="rounded-full px-2 py-0.5 text-xs font-semibold">
                {selectedTaskIndices.length} / {poolTasks.length} Selected
              </Badge>
            </div>
          </AccordionTrigger>
          <AccordionContent className="pt-0 pb-3 px-4 space-y-3">
